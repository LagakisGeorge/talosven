...
Begin VB.Form Syn_DosXorPin 
   ...
   End
End
Attribute VB_Name = "Syn_DosXorPin"
...
' If synarthsh.Caption = "ARAIOSH" Then
 ...
 'End If
 EPANEKTYP.Combo1.AddItem Me.real_q_dis
 EPANEKTYP.apotelesma.Caption = Int(Me.real_q_dis)
...
mpoykali = Val(Syn_DosXorPin.Caption)
...
Else
   MilSec 5000  'cortesi=3000  16/1/2003         2000
End If
   ...
   STR_DOS = STR_DOS + "On=" + str(Int(asw)) + "-"
   Label2.Caption = STR_DOS

If metrhma_1_balbidas = 1 Then
   DUM = katax_katofli(mpoykali, Level, Val(Rate))
   STR_DOS = STR_DOS + "-Real_Rate:" + str(Rate)
Else
...
End If
   ...
   STR_DOS = STR_DOS + "-disp_Rate:" + str(rate1)

  
  
  If asw + 5 >= Val(asked_q) Then GoTo 101
  elax_xronos = (Val(asked_q) - asw - 60) / Val(Rate) ' XRONOS POY MPORO NA KANO DISPENSE XORIS FOBO
...
'=============
   ...
   MilSec 3000  'cortesi=4000   normal=3000
...
'======================================================================
  zht = (asked_q - asw2 - 55)  '  17-9-2002 zht = (Asked_Q - asw2 - 25)
...
If dz <= 3 And prospau > 4 And asw2 + 30 >= asked_q Then
...
Label2.Caption = STR_DOS
     ...
     ' Zyg_Show.width = Int((Val(asw)) / Val(Asked_Q) * 2500)
     ' Zyg_Show = Int((Val(asw)) / Val(Asked_Q) * 100) & " %"
Loop Until Val(asked_q) - Val(asw) < 1500   ' cortesi=1200 normal=1000
'=============
Valve_Off_Click
'=============
MilSec 4000
   ...
   EL_TIME = GetCurrentTime() - start
   asw = Int(1000 * diplo_zygi(1000, 2) - tara)
   real_q_dis = Format(Int(asw + 0.5), "######")
...
'=============
   ...
   MilSec 3000  'cortesi=4000  normal=3000    17-9-2002 HTAN 3000
   asw2 = 1000 * diplo_zygi(1000, 2) - tara
    ...
    ' ΧΡΕΙ’ΖΟΜΑΙ ΛΙΓΟΤΕΡΟ ΑΠΟ 20 ΜΓΡ
                  ...
                  For ll = 1 To 90
                        ...
                        Else
                           ...
                           End If
                        End If
                        asw = Int(1000 * diplo_zygi(1000, 1) + 0.5) - tara
                        If asw <= Val(real_q_dis) Then Ejatmish = Ejatmish * 1.2  ' was 1.5 at 4/7/2002
                        Target_Value.text = Ejatmish
