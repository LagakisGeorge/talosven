...
Begin VB.Form FRMSYNT2 
   ...
   Begin VB.Data PROSXHM 
      ...
      RecordSource    =   $"_synmak9.frx":0000
      Top             =   6465
      Visible         =   0   'False
      Width           =   2745
   End
         ...
         If Not IsNull(PROSXHM.Recordset("seira")) Then
             ...
             If Grid1.Col = 3 Then
                 ...
                 ElseIf PROSXHM.Recordset("gl") > 0 Then
                     Grid1.RowHeight(PROSXHM.Recordset("ayjon")) = YCOS + 1
                 End If
             End If
                If Ok_Print = 1 Then
...
Maskedbox2.left = FIND_LEFT2() ' = 30 + Grid1.left + Grid1.ColWidth(0) + Grid1.ColWidth(1) + 20
 ...
 Grid1.SelStartRow = seira
 Grid1.SelEndRow = seira
